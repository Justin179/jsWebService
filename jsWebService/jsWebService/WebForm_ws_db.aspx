<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm_ws_db.aspx.cs" Inherits="jsWebService.WebForm_ws_db" %>
...
<head runat="server">
    ...
    <script type="text/javascript" language="javascript">
        function GetStudentById() {
            ...
            jsWebService.StudentService.GetStudentById(id, GetStudentByIdSuccessCallback, GetStudentByIdFailedCallback);
        }
